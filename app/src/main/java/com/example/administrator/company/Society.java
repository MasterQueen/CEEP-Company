...
public class Society extends android.support.v4.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.society_layout,null);
    ...
    public void  setView(View view){
        ...
        edit_postion = view.findViewById(R.id.society_postion);
        edit_request = view.findViewById(R.id.society_requset);
        edit_address = view.findViewById(R.id.society_address);
        edit_time = view.findViewById(R.id.society_time);
        edit_people = view.findViewById(R.id.society_people);
        ok = view.findViewById(R.id.society_ok);
