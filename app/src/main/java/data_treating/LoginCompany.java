...
public class LoginCompany {
    ...
    public LoginCompany(String company, String password){
        ...
        try {
            ...
            URL url = new URL("http://47.104.94.221:8080/JWebDemoByIDE/CompanyServlet?company=" + mcompany + "&password=" + mpassword);
